...
def parse_FMT35C(buffer,dex_object,pc_point,offset):
	...
	if ord(buffer[0]) == 0x24:
		...
		prefix="%s"%(dex_object.getmethodfullname(bbbb,True))
		pass
	if A == 5:
...
def parse_instruction(fd,buffer,offset,dex_object):
